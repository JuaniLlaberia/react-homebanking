...
import { faArrowTrendUp, faChartSimple, faMoneyBillTransfer, faHouse } from '@fortawesome/free-solid-svg-icons';
...
const Navbar = () => {
  ...
  return (
    ...
    <nav>
      ...
      <Link to='/exchange' className={`nav-item ${(pathname === '/exchange') ? 'active' : ''}`}><FontAwesomeIcon size='2x' icon={faArrowTrendUp}/><p className='icon-text'>Crypto</p></Link>
