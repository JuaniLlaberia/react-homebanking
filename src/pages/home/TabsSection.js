    ...
    <section className={'tabs-section'} id='section-tabs'>
      ...
      <h5 className='services-title'>OUR SERVICES</h5>
        <ul className='tabs'>
          ...
          <TabSwitcher onClick={() => handleTab(setTab2, setTab1, setTab3)} border='#3730ff' title='Crypto Market' color='#8ca7ff' icon={faArrowRightArrowLeft} active={tab2 ? 'tab-active' : ''}/>
